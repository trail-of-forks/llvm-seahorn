...
extern bool canTryToConstantAddTwoShiftAmounts(Value *Sh0, Value *ShAmt0, Value *Sh1,
  Value *ShAmt1);
...
Instruction *SeaInstCombinerImpl::FoldShiftByConstant(Value *Op0, Constant *C1,
                                                   BinaryOperator &I) {
  // (C2 << X) << C1 --> (C2 << C1) << X
  // (C2 >> X) >> C1 --> (C2 >> C1) >> X
  Constant *C2;
...
Instruction *SeaInstCombinerImpl::foldLShrOverflowBit(BinaryOperator &I) {
