...
static cl::opt<bool>
    VerifyKnownBits("sea-instcombine-verify-known-bits",
...
static cl::opt<unsigned> SimplifyDemandedVectorEltsDepthLimit(
    "sea-instcombine-simplify-vector-elts-depth",
    cl::desc(
...
Value *SeaInstCombinerImpl::SimplifyDemandedUseBits(Instruction *I,
                                                 const APInt &DemandedMask,
                                                 KnownBits &Known,
                                                 unsigned Depth,
                                                 const SimplifyQuery &Q) {
...
Value *SeaInstCombinerImpl::SimplifyDemandedUseFPClass(
...
bool SeaInstCombinerImpl::SimplifyDemandedFPClass(Instruction *I, unsigned OpNo,
