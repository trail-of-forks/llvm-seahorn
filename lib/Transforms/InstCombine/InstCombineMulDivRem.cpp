...
Instruction *SeaInstCombinerImpl::foldPowiReassoc(BinaryOperator &I) {
  auto createPowiExpr = [](BinaryOperator &I, SeaInstCombinerImpl &IC, Value *X,
                           Value *Y, Value *Z) {
...
Instruction *SeaInstCombinerImpl::foldFMulReassoc(BinaryOperator &I) {
  Value *Op0 = I.getOperand(0);
  Value *Op1 = I.getOperand(1);
  Value *X, *Y;
  Constant *C;
...
Instruction *SeaInstCombinerImpl::commonIDivRemTransforms(BinaryOperator &I) {
...
Value *SeaInstCombinerImpl::takeLog2(Value *Op, unsigned Depth, bool AssumeNonZero,
                                  bool DoFold) {
...
convertFSqrtDivIntoFMul(CallInst *CI, Instruction *X,
                        ...
                        InstCombiner::BuilderTy &B, SeaInstCombinerImpl *IC) {
