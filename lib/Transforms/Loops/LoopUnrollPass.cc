...
tryToUnrollLoop(Loop *L, DominatorTree &DT, LoopInfo *LI, ScalarEvolution &SE,
                ...
                bool OnlyFullUnroll, bool ForgetAllSCEV,
...
public:
  ...
  bool runOnLoop(Loop *L, LPPassManager &LPM) override {
    ...
    LoopUnrollResult Result = tryToUnrollLoop(
        ...
        /*OnlyFullUnroll*/ false, ForgetAllSCEV, ProvidedCount,
...
Pass *llvm_seahorn::createSeaLoopUnrollPass(int OptLevel, bool ForgetAllSCEV, int Threshold,
                                            int Count, int AllowPartial, int Runtime,
                                            int UpperBound, int AllowPeeling) {
  // TODO: It would make more sense for this function to take the optionals
  // directly, but that's dangerous since it would silently break out of tree
  // callers.
  return new SeaLoopUnroll(
      OptLevel, ForgetAllSCEV,
